...
using ticketer.Core.Models;

namespace ticketer.Core.Services
{
    ...
    public static class SampleDataService
    {
            ...
            return new List<SampleCompany>()
            {
                new SampleCompany()
                {
                    ...
                    Orders = new List<SampleOrder>()
                    {
                        ...
                        {
                            OrderID = 10643,
                            OrderDate = new DateTime(2021, 2, 22),
                        ...
                        new SampleOrder()
                        {
                            ...
                            OrderTotal = 471.20,
                            Status = "Closed",
                            SymbolCode = 57648, // Symbol Calendar
                            Details = new List<SampleOrderDetail>()
                            {
                                new SampleOrderDetail()
                                {
                ...
                new SampleCompany()
                {
                    ...
                    Orders = new List<SampleOrder>()
                    {
                        new SampleOrder()
                        {
                            ...
                            OrderTotal = 469.75,
                            Status = "Shipped",
                            SymbolCode = 57648, // Symbol Camera
                            Details = new List<SampleOrderDetail>()
                            {
                                new SampleOrderDetail()
                                {
                ...
                new SampleCompany()
                {
                    ...
                    Orders = new List<SampleOrder>()
                    {
                        new SampleOrder()
                        {
                            ...
                            OrderTotal = 978.50,
                            Status = "Closed",
                            SymbolCode = 57648, // Symbol Contact
                            Details = new List<SampleOrderDetail>()
                            {
                                new SampleOrderDetail()
                                {
        ...
        public static async Task<IEnumerable<SampleOrder>> AcceptTicketDataAsync()
        {
            if (_allOrders == null)
            {
                _allOrders = AllOrders();
